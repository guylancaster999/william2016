	        ...
	        <div class="row">
             ...
             <div class="row">
                 <div class="col-lg-8 col-8 col-sm-8">
					...
					<tr>
					<td >M.Glinka</td>
					<td >"Die Lerche"  arr. M.Balakirew</td></tr>
					<tr>
					<td >E.Granados </td>
					<td >Das Mädchen und die Nachtigall (aus Goyescas)</td>
					</tr>
					<tr>
					<td >F.Liszt</td>
					...
					<tr>
					<td>[2015 ist die Centenery seines Todes]&nbsp;&nbsp;&nbsp;</td>
					...
					<tr>
					<td></td>
					<td>Etude Cis-Moll Op.42 Nr.5</td>
					</tr>
					<tr>
					<td></td>
					<td>Etude Des-Dur Op.42 Nr.6</td>
					</tr>
					<tr>
					<td></td>
                ...
                <div class="row">
                 <div class="col-lg-8 col-8 col-sm-8">
					...
					<tr><td >F:Chopin   </td>
					 ...
					 <tr>
					  <td >J.Brahms </td>
					  <td >Variationen über ein Thema von Paganini Op.35 Heft 1   </td>
					 </tr>
				 </table>
           </div>
			<div class="col-lg-4 col-4 col-sm-4">
