...
<body>
    <div id="wrapper">
      <div id="sidebar-wrapper">
            <?php print  menu("en","Biography"); ?>
         </div>
          <div id="page-content-wrapper">
            <div class="container-fluid">
			   <?php topRight("bio_e.php","bio.php","bio_ch.php");?>
                <div class="row">
                 <div class="col-lg-12"> 
                      <h2>Biography</h2>
                   </div>
             ...
             <div class="row">
                 <div class="col-lg-12">    <?php	photoright("IMG_2402.JPG","Img_2402_200.jpg","Bio", "William Cuthbertson plays Beethoven","bio_e.php","en");?>		
					...
					<br/>
					<br/>
					A  very significant person in William Cuthbertson&rsquo;s life is the renowned London-based German pianist, composer and pedagogue Peter Feuchtwanger.
					William Cuthbertson organises annual international <a href="masterclasses_e.php"  title="piano Master Class">Master Class</a> with Peter Feuchtwanger in Waldkirch.
					William Cuthbertson has performed at concerts in Germany, Holland, Poland, Denmark, Norway, England, Scotland, Austria, Sweden, Switzerland and USA. 
					<br/>
					<br/>
