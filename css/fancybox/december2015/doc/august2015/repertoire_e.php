...
<a href="#z">z</a></div>
	     ...
	     <div class="col-sm-3">
                  <?php photorightnolink("Johann_Sebastian_Bach.jpg","Johann%20Sebastian%20Bach-Photo:Wikipedia");?> 
                </div> 	
      </div>
...
<ul>
  ...
  <li>Sonata in C minor Op.111</li>
                 ...
                 <div class="col-sm-3">
 				     <?php photorightnolink("Beethoven.jpg","L.V.Beethoven-Photo:Wikipedia");?> 
                 </div>
 				</div>
       <?php blank_line();?> 
<div class="row">
...
<ul>
  ...
  <div class="col-sm-3">
      <?php photorightnolink("JohannesBrahms.jpg","Johannes Brahms-Photo:Wikipedia")?>
  </div>
  </div>
<div class="row">
                 <div class="col-sm-12">
...
<ul>
  ...
  <li>Barcarolle</li>
  <li>Berceuse</li>
  <li>Tarantella Op.43</a>
</ul>
  </div>
  <div class="col-sm-3">
      <?php photorightnolink("Chopin.png","F.Chopin-Photo:Wikipedia");?>
  </div>
  </div>
<div class="row">
                 <div class="col-sm-9">
...
<li>Reflets dans l'eau ( ab 2001 )</li>
                 ...
                 <div class="col-sm-3">
<?php photorightnolink("Claude_Debussy.jpg","Claude_Debussy%20:%20Photo:Wikipedia");?>
</div>
         </div>
  <?php blank_line();?> 
...
<li>Nocturne in A major</li>
    ...
    <div class="col-sm-3">
   <?php photorightnolink("John_field.jpg","John%20Field-Photo:Wikipedia");?>
    </div>
</div>
  <?php blank_line();?>   
<div class="row">
...
<div class="col-sm-3">
   <?php photorightnolink("Cesar_Franck.jpg","Cesar%20Franck-Photo:Wikipedia");?>
</div>
   </div>
<?php blank_line();?>   
   <div class="row">
...
<ul>
<li><?php linkedPhoto("Rhapsodie%20in%20Blue","Gershwin2.JPG","Repertoire","repertoire_e.php","en");?></li>
</ul>
</div>
		<div class="col-sm-3">
			  <?php photorightnolink("George_Gershwin.jpg","George%20Gershwin-Photo:Wikipedia");?>
        </div>
</div>
               <?php blank_line();?>   
               <div class="row">
...
<div class="col-sm-3">
			  <?php photorightnolink("Mikhail_Glinka.jpg","Mikhail%20Glinka-Photo:Wikipedia");?>
</div>
</div>
            <?php blank_line();?>   
<div class="row">
...
<ul>
  ...
  <li>Suite &quot;From Holberg's Time&quot; Op.40</li>
   ...
   <div class="col-sm-3">
     <?php photorightnolink("Edvard_Grieg.jpg","E.Grieg-Photo:Wikipedia");?>
      </div>
     </div>
     <?php blank_line();?>   
     <div class="row">
...
<ul>
  ...
  <li>Variations in E flat major</li>
               ...
               <div class="col-sm-3">
                   <?php photorightnolink("Joseph_Haydn.jpg","J.Haydn-Photo:Wikipedia");?>
               </div>
            </div>   
...
<div class="col-sm-3">
		<?php  photorightnolink("Anatoly_Lyadov.jpg","Anatoly%20Lyadov-Photo:Wikipedia");?>
</div>
</div>
  ...
  <li>Songs without Words:
    <ul>
      ...
      <li>Op. 102 Nr.3,5</li>
              ...
              <div class="col-sm-3">
                 <?php  photorightnolink("Mendelssohn.jpg","Felix%20Mendelssohn-Photo:Wikipedia"); ?>
              </div>
           </div>
<?php blank_line();?> 
   <div class="row">
...
<li>Etudes Op. 70 Nr. 5, Nr. 9</li></ul>
         ...
         <div class="col-sm-3">
              <?php  photorightnolink("Ignaz_Moscheles.jpg","I.Moscheles-Photo:Wikipedia"); ?>
         </div>
       </div>  
       <?php blank_line();?> 
   <div class="row">
...
<ul>
  ...
  <li>Fantasie in D minor K. 397</li>
   ...
   <div class="col-sm-3">
       <?php  photorightnolink("Mozart.jpg","W.Mozart-Photo:Wikipedia"); ?>
      </div>
   </div>
    <?php blank_line();?> 
    <div class="row">
	 ...
	 <div class="col-sm-3">
	       <?php  photorightnolink("Modest_Musorgskiy.jpg","M.Mussorgski-Photo:Wikipedia"); ?>
     </div>
   </div>
 <?php blank_line();?> 
    <div class="row">
...
<div class="col-sm-3">
           <?php  photorightnolink("Sergei_Prokofiev.jpg","S.Prokofiev-Photo:Wikipedia"); ?>
      </div>
  </div>
<?php blank_line();?> 
 <div class="row">
...
<ul>
  ...
  <li>Sonata in B flat minor Op. 36</li>
   <li>Piano Concerto Number 1</li>
		...
		<div class="col-sm-3">
   	     <?php  photorightnolink("Sergei_Rachmaninoff.jpg", "Sergei%20Rachmaninoff-Photo:Wikipedia"); ?>
     	 </div>
</div>
<?php blank_line();?> 
 <div class="row">
...
<ul>
  ...
  <li>Jeux d'eau</li>
		...
		<div class="col-sm-3">
   	        <?php  photorightnolink("Maurice_Ravel.jpg","Maurice%20Ravel-Photo:Wikipedia"); ?>
     	</div>
</div>
<?php blank_line();?> 
 <div class="row">
...
<ul>
  ...
  <li>Impromptu in B flat major Op. Posth. 142 No. 3</li>
	...
	<div class="col-sm-3">
            <?php  photorightnolink("Franz_Schubert.jpg","Franz%20Schubert-Photo:Wikipedia"); ?>
        </div>
</div>
<?php blank_line();?> 
...
<ul>
  ...
  <li>Fantasy in C major Op.17</li>
	...
	<div class="col-sm-3">
	         <?php  photorightnolink("Schumann.jpg","Robert%20Schumann-Photo:Wikipedia");?>
      </div>
</div>
<?php blank_line();?> 
  ...
  <li>Vers la flamme Op. 72</li>
	...
	<div class="col-sm-3">
      <?php  photorightnolink("Skrjabin_Alexander.jpg","Alexander%20Skrjabin-Photo:Wikipedia");?>
	</div>
</div>
<?php blank_line();?> 
...
<li>Arrangement by Godowski,Fledermaus</li></ul>
	...
	<div class="col-sm-3">
      <?php  photorightnolink("Richard_Strauss.jpg","Richard%20Strauss-Photo:Wikipedia");?>
	</div>
</div>
<?php blank_line();?> 
...
<li>9 Preludes Op. 1</li></ul>
		...
		<div class="col-sm-3">
      <?php  photorightnolink("Karol_Szymanowski.jpg","Karol%20Szymanowski-Photo:Wikipedia");?>
</div>
</div>
<?php blank_line();?> 
	<div class="row">
...
<ul>
  ...
  <li>Doumka Op. 59</li>
		...
		<div class="col-sm-3">
      <?php  photorightnolink("Pjotr_I._Tschaikowski.jpg","Peter%20I%20Tschaikowski-Photo:Wikipedia");?>
</div>
</div>
<?php blank_line();?> 
	<div class="row">
...
<div class="col-sm-3">
	<?php  photorightnolink("Zemlinsky.jpg","Alexander%20von%20Zemlinsky-Photo:Wikipedia");?>
</div>
</div>
<div class="row">
		<div class="col-sm-12">
