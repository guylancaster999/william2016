    ...
    <div id="wrapper">
       <div id="sidebar-wrapper">
          ...
          <div id="page-content-wrapper">
		    ...
		    <div class="row rgp">
				<div class="col-md-2 boldTxt">9th/10th September<br/>5pm</div>
				...
				<div class="col-md-2">
				   <img class="pic"  src="img/elfenau.jpg"  alt="Elfenau Park">
				</div>
			</div>
				<div class="row rgp">
  		    ...
  		    <div class="row rgp">
				<div class="col-md-2 boldTxt">Friday 11th March</div>
				...
				<div class="col-md-2"> 
					<img class="pic"  src="img/sonneneck.jpg" width="240" alt="Haus Sonneneck" />
	      	</div>
		</div>
	 	<div class="row rgp">
    		<div class="col-md-2 boldTxt">Sunday 20th March</div>
    		...
    		<div class="col-md-2">
			  <a href="http://www.stbeatus.ch/">
			     <img class="pic"  src="img/stbeatus.jpg" alt="Stiftung St.Beatus"  />
			  </a>
					</div>
			</div>
			<div class="row rgp">
				<div class="col-md-2 boldTxt">Wednesday 25th May<br/>6pm</div>
				<div class="col-md-8">
					...
					<div class="col-md-2">
					    <a href="http://balamus.ru"">
     						<img class="pic" src="img/russiaconcert_240.jpg" alt="Balakhna Museum für Geschichte und Kunst">
						</a>
					</div>
					</div>
					<div class="row rgp">
						<div class="col-md-2 boldTxt">Sunday<br/> July 3rd<br/> 11 a.m.</div>
						...
						<div class="col-md-2">
    						<a href="#" title="Etzal Museum">
								<img class="pic" src="img/etzal_240.jpg" alt="Etzal Museum">
							</a>
						</div>
						</div>
						<div class="row rgp">
						<div class="col-md-2 boldTxt">
						  Sunday 10th Juli <br/>11 am</div>
						  <div class="col-md-8">
						...
						<div class="col-md-2">
							<a href="#" title="William Cuthbertson, Carina Kaltenbach" >
								<img class="pic"  src="img/duo.jpg" alt="William Cuthbertson, Carina Kaltenbach" />
							</a>
						</div>
					</div>
					<div class="row rgp">
						<div class="col-md-2 boldTxt"><a name="31st" id="31st"></a>
							Wednesday<br/>August 31st <br/>5.30pm
						</div>
						<div class="col-md-8">
					 <b>G.Rossini's "Semiramide" Overture, arr. Czerny, for 16 pianists on 8 pianos.</b>
					 <br/>
				...
				To book, please email: <A href="mailto:feuchtwanger-memorial@email.de">feuchtwanger-memorial@email.de</a>.
				</div>
				<div class="col-md-2">
	         	<img class="pic" src="img/pianos.png" alt="Pianos">
		</div>
		</div>
				<div class="row rgp">
						<div class="col-md-2 boldTxt">
							Wednesday<br/>August 31st <br/>7.30pm
						</div>
						<div class="col-md-8"><b>A memorial concert for Peter Feuchtwanger, featuring many of his former students</b>.
					<br/>At the Baroque room,  Elztalmuseum, Waldkirch.
					<ul>
			...
			More information <a href="https://www.facebook.com/events/1060483480654681/">here</a>.
			</div>
		<div class="col-md-2">
	         	<img class="pic" src="img/Peter_Feuchtwanger_250.jpg" alt="Peter_Feuchtwanger">
		</div>
	</div>
	<div class="row rgp">
				...
				<div class="row rgp">
						...
						<div  class="col-md-2">
							<a href="#" title="http://www.klappe11.de/">
								<img class="pic" src="img/klappe11.jpg" alt="Klappe11 Festival"/>
							</a>
						</div>
					</div>
					<div class="row rgp">
						<div class="col-md-2 boldTxt">
							Sat 28th/Sun 29th March<br/> 5pm
						</div>
						<div class="col-md-8">
						<ul>
					...
					<div class="col-md-2">	
						<a href="http://bz-ticket.de/orgelbauersaal-waldkirch-waldkirch">
						<img class="pic" src="img/orgelbauersaal_240.jpg" alt="orgelbauersaal">
					</a>
						</div>
					</div>
					<div class="row rgp">
						<div class="col-md-2 boldTxt">
							Sunday 19th September<br/>7.30pm
					</div>
					<div class="col-md-8">
						Benefit Concert donated for the renovation of the community center<br/>
						With:<ul>
	           	...
	           	<div class="row rgp">
					  ...
					  <br/> Catholic community center , Church Square 7, Waldkirch. At the Piano: William Cuthberson, Waldkirch; 
						...
						<div class="col-md-2">	
						   ...
						   <img src="img/Skrjabin_Alexander_240.jpg">
						</div>
					</div>
					<div class="row rgp">
						<div class="col-md-2 boldTxt">
							Sunday 27th December<br/>7.30pm
						</div>
						<div class="col-md-8">
					<b>Poetry and und Piano</b>
					<br/>
							...
							At <a href="http://www.rehaklinik-sonneneck.de">Haus Sonneneck</a>, Kanderner Strasse 18, 79410 Badenweiler, Breisgau-Hochschwarzwald, Baden-Württemberg, Germany.  Tickets 12 €.
							</div>
						<div class="col-md-2">	
				...
				<div class="row rgp">
					<div class="col-md-2 boldTxt">
						Sunday 26th January<br/> 10.30am
					</div>
					<div class="col-md-8">
				...
				<div class="row rgp">
					...
					<div class="col-md-8">
						...
						With:<ul>
						<li> Margriet%20van%20Reisen</li>
						<li>Antoine%20Billet, Cello;  </li>
				...
				<div class="row rgp">
					...
					<div class="col-md-2">
						<a  title="Mozart to Bob Dylan" href="https://www.facebook.com/#!/events/532745816825705">
				...
				<div class="row rgp">
					<div class="col-md-2 boldTxt">
						...
						At Stadtrainsee, Waldkirch. The Orchestra will play dance music from the 1930s to the 60s.
						</div>
				<div class="col-md-2">
				       <A href="https://www.facebook.com/events/418229254981777/">
				...
				<div class="row rgp">
					...
					<div class="col-md-2">
						<a title="" href="https://www.facebook.com/events/747215315337186">
				...
				<div class="row rgp">
						<div class="col-md-2 boldTxt">
							Wednesday 6th. August<br/>12 noon
						</div>
						<div class="col-md-8">
						<strong>Informal Concert</strong>
						<br/>
		...
		<a href="http://www.islay-gaelic.net">
				...
				<div class="row rgp">
					<div class="col-md-2">Thursday 16th October<br/>8pm 
					</div>
					<div class="col-md-8"> 
				...
				<div class="row rgp">
					<div class="col-md-2 boldtxt">September 28th,<br/> September 29th <br/>
						5pm
					</div>
					<div class="col-md-8">
					...
					<div class="row rgp">
					<div class="col-md-2 boldtxt"> October 10th <br/> 
						8pm</div>
						<div class="col-md-8">
