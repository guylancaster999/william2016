...
print head("en","Peter Feuchtwanger Masterclass 2016");
?>
<body>   <div id="wrapper">
      <div id="sidebar-wrapper">
          <?php print menu("en","Masterclass","masterclasses_e.php","meisterkurse.php","masterclasses_ch.php");?>
         </div>
          <div id="page-content-wrapper">
            <div class="container-fluid">
				...
				<h3>29th August &ndash;&nbsp;3rd September 2016	<br/>
					With William Cuthbertson, Manfred Seewann and Matina Barufke. </h3>
						...
						<a title="Peter Feuchtwanger" href="http://peter-feuchtwanger.de/english-version" target = "_blank"><strong>Peter Feuchtwanger</strong></a> (26.6.1930-18.6.2016) 
						...
						He also researched into <A href="https://de.wikipedia.org/wiki/Belcanto" target = "_blank">Belcanto</a>, the technique used in the golden age of singing. 
						Peter Feuchtwanger was a member of the jury of many international piano competitions and Vice President of <A href="http://www.epta-uk.org/" target = "_blank">EPTA UK</a> (European Piano Teachers' Association). 
						...
						and was visiting Professor at the <a href="https://www.moz.ac.at/en/" target = "_blank">Mozarteum</a> in Salzburg. 
						Since 1967, he gave master classes throughout the world.
						Click <a title="Daily Telegraph Obitury" href="http://www.telegraph.co.uk/obituaries/2016/06/28/peter-feuchtwanger-piano-teacher--obituary/">here</a> for more.
					</div>
					<br/>
					The masterclass  includes:
					<ul>
					<li>Daily master classes with William Cuthbertson 
					...
					<li>August 31st 7.30pm	&ndash;	Instead of the concert by the guest artists Sanja Stefanovic and Sophia Grech, there will be a memorial concert for Peter Feuchtwanger on August 31st. 
					Many of Prof.Feuchtwanger’s former pupils have agreed to come and perform.
					Details <A href="concert_e.php#31st">here</a>.
					<br class="brclear"/> 
					<br/>
					</li>
					<li>September 3rd Closing concert by the course participants, Elztalmuseum Waldkirch 7.30 pm
					<br/><br/>
					</li>
					</ul>
					Further details:
