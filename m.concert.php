...
<div data-role="page" id="pageone">
	...
	<th colspan="2" class="year">2017</th>
			...
			<tr>
			<td><b>Samstag 9, Sontag 10<br/>September<br/>
			17.00 Uhr</b></td>
			<td><img src="img/elfenau.jpg" align="right" alt="Elfenau Park"/><b>
			Konzert im <a href="http://www.elfenaupark.ch/">Elfenau Park</a> </b><br/>Bern, Schweiz.
			<ul>
			...
			<tr>
				...
				<td><b>Konzert im <a href="http://www.rehaklinik-sonneneck.de">Haus Sonneneck</a></b>
				<br/>
			...
			<tr>
				<td><strong>Sontag&nbsp;20&nbsp;<br/>März<br/>15:00 Uhr</strong></td>
					<td> <a href="http://www.stbeatus.ch/"><img src="img/stbeatus.jpg" alt="Stiftung St.Beatus"  align="right" /></a><strong>Konzert im <a href="http://www.stbeatus.ch/">Stiftung Beatus</a></strong>
					<br/>Bühlweg 2, 3655 Sigriswil, Schweiz. 
					<ul>
					<li>A.Skrjabin Sonate Nr.2 Op.19</li>
					<li>S.Rachmaninow Prelude D-Dur Op.23 Nr.4</li>
					<li>F.Schubert Impromptu Ges-Dur Op.90 Nr.3</li>
					<li>F.Chopin Sonate Nr.2 b-Moll Op. 35</li></ul>
					</td>
				</tr>
				<tr>
					<td><strong>Mittwoch 25 Mai&nbsp;<br/>18.00 Uhr</strong></td>
		 			<td><?php photorightlinked("russiaconcert_240.jpg","Balakhna Museum für Geschichte und Kunst","http://balamus.ru");?>
					<b>Konzert im <a href="http://balamus.ru">Balakhna Museum für Geschichte und Kunst</a></b>
					<br/>Nischni Nowgorod, Russland. 
		...
		<tr> 		
			...
			<tr>
				...
				"");?>
				Benefizkonzert zugunsten des Umbaus des Gemeindezentrums<br/>
			...
			<tr>
				...
				<td><?php photoright("Skrjabin_Alexander.jpg","Skrjabin_Alexander_240.jpg","konzerte","Skriabin Alexander.jpg","concert.php","de");?>
				<b>Der Musiker Alexander Skrjabin (1871-1915) Konzert und Vortrag</b> 
			...
			<th colspan="2" class="year">2014</th>
				...
				<td><?php photorightlinked("openair2014_240.jpg","Open Air Konzert","");?> 
				<strong>Open Air Konzert mit den Waldkircher Tanzrhythmiker</strong>
				<br/>
				...
				"");?>
				 <strong>Wilhelm Busch Abend mit William Cuthbertson und Martin Lunz</strong> 
				<br/>
				...
				20 Uhr</strong></td>
				<td valign="top">Dr.Ulrich Ruh (Herder-Korespondenz)
				<br />
