...
<body>
    <div id="wrapper">
         <div id="sidebar-wrapper">
            <?php print  menu("de","Biographie","bio_e.php","bio.php","bio_ch.php"); ?>
         </div>
          <div id="page-content-wrapper">
            <div class="container-fluid"> 
                ...
                <div class="row">
             	...
             	<div class="row">
                	<div class="col-lg-12">         
 					<h3>Klassischer Pianist</h3>
							<?php	photoright("IMG_2402.JPG","Img_2402_200.jpg","Bio", "William Cuthbertson spielt Beethoven","bio.php","de");?>				
Seit vielen Jahren geh&ouml;rt der in Waldkirch lebende Pianist William Cuthbertson zu den bedeutenden Protagonisten auch der regionalen Kulturszene.
...
William Cuthbertson hat Konzerte in  Russland, Deutschland, Holland, Polen, Dänemark, Norwegen, England, Österreich, Schweden, der Schweiz und in den USA gegeben. 
